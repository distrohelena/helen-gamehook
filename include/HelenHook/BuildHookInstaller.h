...
{
    /**
     * @brief Installs declarative blob-backed inline hooks for the active multi-pack runtime.
     *
    ...
    public:
        ...
        /**
         * @brief Creates one hook installer with no fixed pack ownership.
         */
         ...
         * @param hooks Pack-scoped hook declarations loaded from the selected build metadata.
