...
[void][Win32HelenStep]::SetCursorPos($x, $y)
Start-Sleep -Milliseconds 150
[Win32HelenStep]::mouse_event(0x0002, 0, 0, 0, [UIntPtr]::Zero)
Start-Sleep -Milliseconds 50
[Win32HelenStep]::mouse_event(0x0004, 0, 0, 0, [UIntPtr]::Zero)
Start-Sleep -Seconds 4
Snap $p 'C:\dev\helenhook\artifacts\batman-relaunch-after-start.png'
