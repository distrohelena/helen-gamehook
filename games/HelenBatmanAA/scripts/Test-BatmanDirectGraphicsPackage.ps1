...
& (Join-Path $PSScriptRoot 'Invoke-BatmanConsoleTool.ps1') -FilePath (Join-Path $verificationRoot 'VerifyPackage.exe') -Arguments @($PackParent, $BasePath, $TargetPath, $NativeDllPath)
